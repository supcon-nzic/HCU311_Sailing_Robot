...
if("TRUE" STREQUAL "TRUE")
  set(sailing_robot_SOURCE_PREFIX /home/yqz/matplot_new/src/sailing_robot)
  set(sailing_robot_DEVEL_PREFIX /home/yqz/matplot_new/devel)
  ...
  set(sailing_robot_INSTALL_PREFIX /home/yqz/matplot_new/install)
...
if(NOT "/home/yqz/matplot_new/devel/include " STREQUAL " ")
  set(sailing_robot_INCLUDE_DIRS "")
  set(_include_dirs "/home/yqz/matplot_new/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sailing_robot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yqz/matplot_new/src/sailing_robot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yqz/matplot_new/devel/lib;/home/yqz/matplot_new/devel/lib;/opt/ros/kinetic/lib)
