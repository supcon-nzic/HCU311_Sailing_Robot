...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sailing_robot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yqz/HCU-311-V1.0.0/simulator/sailing_robot_master/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yqz/HCU-311-V1.0.0/simulator/sailing_robot_master/install/lib;/home/yqz/HCU-311-V1.0.0/simulator/sailing_robot_master/devel/lib;/home/yqz/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
